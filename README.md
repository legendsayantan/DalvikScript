...
Execute Java/Kotlin code on Android devices without compiling into apps.

## Features

- **Blazing-fast Java execution on Android**  
    Execute Java/Kotlin files or code snippets on a connected Android device, instantly.
...
Check the [demo folder](https://github.com/legendsayantan/DalvikScript/tree/master/demo) for general things you can control via DalvikScript, or explore [Android source](https://cs.android.com) to find useful apis you can invoke using Java Reflection.
